...
export default function Contact() {
  return (
    <section id="contact" className="overflow-hidden pt-28 md:pt-32 xl:pt-36 bg-gradient-to-b from-hoverColor to-hoverColor" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="2">
